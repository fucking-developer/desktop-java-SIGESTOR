...
public class DialogoCapturarEliminacionDirecta extends JDialog implements WindowListener {
	...
	/**
	 * Bot�n <code>Mostrar Reporte</code>.
	 * 
	...
	/**
	 * Bot�n <code>Modificar resultados</code>.
	 * 
	...
	/**
	 * Bot�n <code>Cancelar ciclo</code>.
	 * 
	 * @see #accionBtnCancelarRonda()
	 * 
	 *      El bot�n ser� personalizable en ciclo, por que depender� del nombre
	 *      asignado.
	 */
	private JButton botonCancelarCiclo;

	/**
	 * Bot�n <code>Salir</code>.
	 * 
	 * @see #accionBtnSalir()
	 */
	...
	/**
	 * Arreglo de etiquetas para los n�meros que identificar�n a los participantes
	 * iniciales.
	 */
	...
	/**
	 * Variable temporal que indicar� si se activaron los marcadores o no.
	 */
	private boolean validacionMarcadores;

	/**
	 * Variable que llevar� el control si se modifican los resultados del ciclo.
	 */
	private boolean estadoModificar = false;

	/**
	 * Constructor en el que se inicializa el di�logo. .
	 * 
	 * @param principal
	...
	public DialogoCapturarEliminacionDirecta(VentanaPrincipal principal) {
		...
		JLabel etiquetaTipoTorneo = new JLabel("Eliminaci�n Directa");
		...
		// JLabel etiquetaCicloActual = new JLabel("Eliminaci�n");
		...
		campoOrganizador = new JTextField("Manuel Alejandro Vald�z Marrero");
		...
		Action accionSeleccionarCiclo = new AbstractAction("Seleccionarciclo", null) {
			...
			public void actionPerformed(ActionEvent e) {
				...
				etiquetaElegirCiclo.setText("Personalizaci�n" + " actual: " + "ciclo");
				// habilitarBotones();
		...
		JLabel etiquetaTitulosTabla = new JLabel("N�m.");
		auxPanel = new JPanel();
		...
		etiquetaTitulosTabla = new JLabel("N�m.");
		auxPanel = new JPanel();
		auxPanel.setPreferredSize(new Dimension(50, altoTitulos));
		auxPanel.add(etiquetaTitulosTabla);
		auxPanel.setBorder(BorderFactory.createCompoundBorder(borde, borde));
		...
		accionGuardar.putValue(Action.SHORT_DESCRIPTION,"Guarda el resultado de cada partida.Deshabilita la edici�n de los resultados capturados");
		// if (validacionMarcadores) {
		...
		// + ". " + "Deshabilita la edici�n de los resultados capturados");
		// } else {
		// accionGuardar.putValue(Action.SHORT_DESCRIPTION,
		...
		accionSalir.putValue(Action.SHORT_DESCRIPTION, "Cierra la ventana y regresa al men� principal");
	...
	/**
	 * Establece el tama�o, la posici�n y el no redimensionamiento al ejecutarse la
	 * ventana.
	 */
	...
	/**
	 * Obtiene toda la informaci�n de un ciclo al ser seleccionado en el combo.
	 */
	 ...
	 * <code>Cancelar ciclo</code> �nicamente si se encuentra en el ciclo actual
	 */
	...
	/**
	 * Obtiene toda la informaci�n almacena en un ciclo.
	 * 
	 ...
	 * 
	 * @param torneo
	 *            Recibe el objeto <code>Torneo</code> con la informaci�n del
	 *            torneo.
	 */
	 ...
	 * ventana <code>Capturar resultados</code> al presionar el bot�n
	 * <code>Guardar</code>.
	 */
	 ...
	 * <code>Capturar resultados</code> al presionar el bot�n
	...
	private void salir() {
		if (estadoModificar) {
			String[] valores = { "S�", "Guardar y salir", "Cancelar" };
			int opcion = JOptionPane.showOptionDialog(this,
					"Los resultados no han sido guardados.\nToda la informaci�n ingresada se perder�."
	...
	/**
	 * Permite mostrar mensajes al usuario al presionar el bot�n
	 * <code>Modificar resultados</code>.
	 */
	private void accionBtnModificarResultados() {
		Object[] opciones = { "S�", "No" };
		int respuesta = JOptionPane.showOptionDialog(null, "�Est� seguro(a) de que desea modificar los resultados?",
	...
	/**
	 * Permite mostrar mensajes al usuario al presionar el bot�n
	 * <code>Cancelar ciclo</code> advirtiendo lo que suceder� al decidir cancelar
	 * el ciclo del torneo.
	 */
	private void accionBtnCancelarRonda() {

		Object[] opciones = { "S�", "No" };
		int respuesta1 = JOptionPane.showOptionDialog(null, "�Est� seguro de cancelar " + "?", "Cancelar",
		...
		if (respuesta1 == JOptionPane.YES_OPTION) {
			int respuesta2 = JOptionPane.showOptionDialog(null,
					"Si se cancela se perder�n todos los resultados \n incluyendo " + "."
							+ "\n �Est� realmente seguro de cancelar " + "?",
	...
	/**
	 * Elimina el ciclo y los encuentros que est�n en �l, tambien actualiza el
	...
	/**
	 * Permite salir de la ventana con el bot�n <code>Salir</code>.
	 */
