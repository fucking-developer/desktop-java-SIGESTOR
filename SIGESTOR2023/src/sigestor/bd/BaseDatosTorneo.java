...
public class BaseDatosTorneo extends BaseDatos {
	 ...
	 * 
	 * @param nombreArchivo Nombre del archivo de la base de datos.
	 * @throws ExcepcionBaseDatos       Lanza la excepción sí no se pudo realizar la
	 *                                  conexión.
	 * @throws ExcepcionBaseDatosTorneo Lanza la excepción sí ocurre un error al
	 *                                  validar la existencia del archivo y al
	 *                                  validar las tablas o sí ocurre un error al
	 ...
	 * @throws ExcepcionBaseDatos       Lanza la excepción sí no se pudo realizar la
	 *                                  conexión.
	 * @throws ExcepcionBaseDatosTorneo lanza la excepcion si no se puede crear la
	 *                                  base de datos.
	 */
	 ...
	 *                                  <code>datosGenerales</code> en la base de
	 *                                  datos.
	 */
	 ...
	 *                                  conexión.
	 * @throws ExcepcionBaseDatosTorneo Lanza la excepción sí ocurre un error al
	 *                                  actualizar el ciclo actual en tabla
	 *                                  <code>datosGenerales</code> de la base de
	 *                                  datos.
	 */
	 ...
	 *                                  conexión.
	 * @throws ExcepcionBaseDatosTorneo Lanza la excepción sí ocurre un error al
	 *                                  obtener las tablas o sí el archivo no es del
	 *                                  sistema.
	 */
	private boolean validarTablas() throws ExcepcionBaseDatos, ExcepcionBaseDatosTorneo {
		...
		if (tablas.size() == 8 && contador == 8) {
			band = true;
		} else if (tablas.size() == 0) {
			band = false;
		} else if (tablas.size() != 8 || contador != 8) {
	 ...
	 *                                  conexión.
	 * @throws ExcepcionBaseDatosTorneo Lanza la excepción si ocurre un error al
	 *                                  obtener el número de ciclos en la tabla
	 *                                  <code>suizo</code> de la base de datos.
	 */
	 ...
	 * 
	 * @param robin Contiene el número de ciclos y el número de vueltas del torneo.
	 * @throws ExcepcionBaseDatos       Lanza la excepción sí no se pudo realizar la
	 *                                  conexión.
	 * @throws ExcepcionBaseDatosTorneo Lanza la excepción sí ocurre un error al
	 ...
	 * datos.
	 * 
	 * @param torneoSuizo Contiene los datos generales del torneo suizo.
	 * @throws ExcepcionBaseDatos       Lanza la excepción sí no se pudo realizar la
	 *                                  conexión.
	 * @throws ExcepcionBaseDatosTorneo Lanza la excepción si ocurre un error al
	 *                                  insertar el número de ciclos en la tabla
	 *                                  <code>suizo</code> de la base de datos.
	 */
	 ...
	 *                                  conexión.
	 * @throws ExcepcionBaseDatosTorneo Lanza la excepción si ocurre un error al
	 *                                  eliminar el número de ciclos en la tabla
	 *                                  <code>suizo</code> de la base de datos.
	 */
