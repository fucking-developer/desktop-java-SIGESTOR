...
/**
 * Sirve para insertar y actualizar los datos de personalizaci�n en la base de
 * datos.
 * 
 * @version 12/06/2022
 * 
...
public class BaseDatosPersonalizacion extends BaseDatos {
	...
	/**
	 * Inserta los datos de personalizaci�n a la base de datos.
	 * 
	 * @param personalizacion Contiene los datos de personalizaci�n.
	 * @throws ExcepcionBaseDatos                Lanza la excepci�n s� no se pudo
	 *                                           realizar la conexi�n.
	 * @throws ExcepcionBaseDatosPersonalizacion Lanza la excepci�n si no se
	...
	/**
	 * Actualiza los datos de personalizaci�n guardados en la base de datos.
	 * 
	 * @param personalizacion Contiene los datos de personalizaci�n.
	 * @throws ExcepcionBaseDatos                Lanza la excepci�n s� no se pudo
	 *                                           realizar la conexi�n.
	 * @throws ExcepcionBaseDatosPersonalizacion Lanza la excepci�n s� no se pudo
	...
	/**
	 * Obtiene de la base de datos los datos de personalizaci�n del torneo.
	 * 
	 * @return regresa un objeto de tipo <code>Personalizacion.</code>
	 * @throws ExcepcionBaseDatos                Lanza la excepci�n s� no se pudo
	 *                                           realizar la conexi�n.
	 * @throws ExcepcionBaseDatosPersonalizacion Lanza la excepci�n si ocurre un
