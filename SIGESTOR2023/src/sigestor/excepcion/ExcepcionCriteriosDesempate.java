 ...
 * marcador a favor, marcador en contra, si el marcador no fue seleccionado</li>
...
public class ExcepcionCriteriosDesempate extends Exception {
	 ...
	 */
	public static final String MENSAJE_EXCEPCION_CRITERIOS_INVALIDOS = "No se pueden utilizar los siguientes criterios de desempate: Diferencia de marcadores, Marcador en contra y Marcador a favor, si no hay marcadores selecionados.";
