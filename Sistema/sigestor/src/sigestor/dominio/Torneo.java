 ...
 * <p>
 * Las caracter�sticas de la clase <code>Torneo</code> son:
 * <ul>
 ...
 * del torneo.</li>
 * <li><code>fechaInicioTorneo</code> Para almacenar la fecha en que se iniciar�
 * el torneo.</li>
 * <li><code>fechaFinalTorneo</code> Para almacenar la fecha en que finalizar�
 * el torneo.</li>
 * <li><code>cicloActual</code> Para almacenar el ciclo en que se encuentra el
 * torneo.</li>
 * <li><code>algoritmoTorneo</code> Para almacenar el algoritmo con que podr�
...
public class Torneo {
	...
	/**
	 * Criterios de desempate que se utilizar�n en el torneo.
	 */
	...
	/**
	 * Tipo de torneo que se llevar� a cabo.
	 */
	...
	/**
	 * Fecha en que finalizar� el torneo.
	 */
	private Date fechaFinalTorneo;
	/**
	 * Ciclo en que se encuentra el torneo, si su valor es <tt> 0 </tt> el
	 * torneo no ha sido iniciado.
	 */
	private int cicloActual;

	/**
	 * Algoritmo que se utilizar� para el avance del torneo.
	 */
	...
	/**
	 * M�todo que sirver para devolver el valor de la variable <code>nombreArchivo</code>
	 * 
	...
	/**
	 * M�todo que sirve para recibir el valor de la variable <code>nombreArchivo</code>
	 * 
	 * @param nombreArchivo El nombre del archivo que contendr� el torneo.
	 */
	...
	/**
	 * Devuelve los datos de personalizaci�n del torneo.
	 * 
	 ...
	 * <code>datosPersonalizacion</code>.
	 * 
	...
	/**
	 * Asigna el par�metro recibido a la lista <code>listaParticipantes</code>.
	 * 
	...
	/**
	 * Asigna el par�metro recibido a la variable <code>nombreTorneo</code> y
	...
	/**
	 * Asigna el par�metro recibido a la variable <code>tipoTorneo</code> y
	 * elimina espacios si existen al inicio y al final de la cadena.
	 * 
	 * @param tipoTorneo
	...
	/**
	 * Asigna el par�metro recibido a la variable <code>nombreOrganizador</code>
	 * y elimina espacios si existen al inicio y al final de la cadena.
	 * 
	...
	/**
	 * Asigna el par�metro recibido a la variable
	 * <code>fechaInicioTorneo</code>.
	 * 
	 * @param fechaInicioTorneo
	 *            Recibe la fecha en que iniciar� el torneo.
	 */
	...
	/**
	 * Devuelve la fecha en que finalizar� el torneo.
	 * 
	 * @return Regresa la fecha en que finalizar� el torneo.
	 */
	...
	/**
	 * Asigna el par�metro recibido a la variable <code>fechaFinalTorneo</code>.
	 * 
	 * @param fechaFinalTorneo
	 *            Recibe la fecha en que finalizar� el torneo.
	 */
	 ...
	 * 
	 * @return Regresa el ciclo actual del torneo,<tt> 0 </tt> en caso de el
	 *         torneo no ha sido iniciado.
	 */
	...
	/**
	 * Asigna el par�metro recibido a la variable <code>cicloActual</code>.
	 * 
	 * @param cicloActual
	...
	/**
	 * Devuelve una descripci�n del torneo.
	 * 
	 * @return Regresa la descripci�n del torneo.
	 */
	...
	/**
	 * Asigna el par�metro recibido a la variable <code>descripcionTorneo</code>
	 * y elimina espacios si existen al inicio o al final de la cadena.
	 * 
	 * @param descripcionTorneo
	 *            Recibe la descripci�n del torneo.
	 */
	...
	/**
	 * Asigna el par�metro recibido a la variable <code>algoritmoTorneo</code>.
	 * 
	 ...
	 * @param torneoRoundRobin Recibe el torneo <code>Round Rob�n</code> si es el caso.
	 * @param torneoSuizo Recibe el torneo <code>Suizo</code> si es el caso.
	 * @throws ExcepcionBaseDatosCiclo        Lanza la excepci�n s� ocurre un error
	 *                                        en <code>BaseDatosCiclo</code>.
	 * @throws ExcepcionBaseDatosEncuentro    Lanza la excepci�n s� ocurre un error
	 *                                        en <code>BaseDatosEncuentro</code>.
	 * @throws ExcepcionBaseDatos             Lanza la excepci�n s� ocurre un error
	 *                                        en <code>BaseDatos</code>.
	 * @throws ExcepcionBaseDatosTorneo       Lanza la excepci�n s� ocurre un error
	 *                                        en <code>BaseDatosTorneo</code>.
	 * @throws ExcepcionBaseDatosParticipante Lanza la excepci�n s� ocurre un error
	 *                                        en <code>BaseDatosParticipante</code>.
	 * @throws ExcepcionCapturarResultados    Lanza la excepci�n si ocurre un error
	 *                                        al crear el objeto
	 *                                        <code>Encuentro</code>.

	 */
	public void iniciarTorneo(TorneoRoundRobin torneoRoundRobin, TorneoSuizo torneoSuizo)
			throws ExcepcionBaseDatos, ExcepcionBaseDatosEncuentro, ExcepcionBaseDatosCiclo, ExcepcionBaseDatosTorneo, ExcepcionCapturarResultados, ExcepcionBaseDatosParticipante {
		ordenarParticipantes();
		// se crea un objeto de tipo algoritmo
	 ...
	 *             Lanza la excepci�n si la variable <code>nombreTorneo</code>
	 *             se encuentra vac�a. Lanza la excepci�n si la variable
	 *             <code>nombreOrganizador</code> se encuentra vac�a. Lanza la
	 *             excepci�n si la variable <code>fechaFinalTorneo</code> es
	 *             menor que la variable <code>fechaInicialTorneo</code>.
	 */
	...
	/**
	 * Permite recuperar los datos de la base de datos para ingresarlos al
	 * objeto <code>Torneo</code>.
	 * 
	 * @throws ExcepcionBaseDatos
	 *             Lanza la excepci�n s� ocurre un error en
	 *             <code>BaseDatos</code>.
	 ...
	 *             Lanza la excepci�n s� ocurre un error al capturar los
	 *             resultados.
	...
	public void recuperarTorneo()
		...
		this.setDatosPersonalizacion(bdPersonalizacion.obtenerPersonalizacion());
	...
	/**
	 * Permite actualizar los datos de la base de datos para ingresarlos al
	 * objeto <code>Torneo</code>.
	 * 
	 * @throws ExcepcionBaseDatos
	 *             Lanza la excepci�n s� ocurre un error en
