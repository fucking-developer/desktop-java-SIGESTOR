 ...
 * marcador a favor, marcador en contra y marcador de participante final, si el
 * marcador no fue seleccionado.</li>
 ...
 * Para informar que un torneo de tipo Eliminación directa solo se puede iniciar
 * utilizando los criterios de desempate: Puntuación y Marcador de participante
 * final.
 * <li>
 * </ul>
 * 
...
public class ExcepcionCriteriosDesempate extends Exception {
	 ...
	 */
	public static final String MENSAJE_EXCEPCION_LISTA_VACIA = 
			"Verifique que exista al menos un criterio de desempate seleccionado.";

	/**
	 * Mensaje 2.3.2 del documento de mensajes del sistema.
	 */
	public static final String MENSAJE_EXCEPCION_CRITERIOS_INVALIDOS = 
			"No se pueden utilizar los siguientes criterios de desempate:"
			+ "\nDiferencia de marcadores, Marcador en contra, "
			+ "\nMarcador a favor y Marcador de participante final,"
			+ "\nsi no hay marcadores selecionados.";
	 ...
	 */
	public static final String MENSAJE_EXCEPCION_CRITERIOS_INVALIDOS_ELIMINACION_DIRECTA = 
			"El torneo de tipo Eliminación directa solo puede utilizar los criterios de desempate:"
			+ "\nPuntuación y Marcador de participante final.";
