...
public class ExcepcionPersonalizacion extends Exception {
	...
	/**
	 * Mensaje 2.4.1 referente al documento de mensajes del sistema
	 */
	...
	/**
	 * Mensaje 2.4.2 referente al documento de mensajes del sistema
	 */
	...
	/**
	 * Mensaje 2.4.3 referente al documento de mensajes del sistema
	 */
	...
	/**
	 * Mensaje 2.4.4 referente al documento de mensajes del sistema
	 */
	...
	/**
	 * Mensaje 2.4.5 referente al documento de mensajes del sistema
	 */
	...
	/**
	 * Mensaje 2.4.6 referente al documento de mensajes del sistema
	 */
	...
	/**
	 * Mensaje 2.4.7 referente al documento de mensajes del sistema
	 */
	...
	/**
	 * Mensaje 2.4.8 referente al documento de mensajes del sistema
	 */
