 ...
 *
 */
public class DialogoMostrarResultadosEliminacionDirecta extends JDialog {
	 ...
	 */
	public DialogoMostrarResultadosEliminacionDirecta(VentanaPrincipal principal, int indiceMostrarResultados) {
		...
		JLabel etiquetaTipoTorneo = new JLabel("Sistema Eliminación Directa" );
		etiquetaTipoTorneo.setFont(
				new Font(etiquetaTipoTorneo.getFont().getFontName(), etiquetaTipoTorneo.getFont().getStyle(), 25));
		auxPanel = new JPanel();
		...
		accionSeleccionarCiclo.putValue(Action.SHORT_DESCRIPTION,
				"Seleccione el(la) <ciclo>" + " para ver los resultados");
