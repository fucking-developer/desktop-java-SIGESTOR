 ...
 */
public class DialogoResultadosFinalesEliminacionDirecta extends JDialog implements ActionListener {
	...
	JPanel panelEncabezadoTablas = new JPanel();
	 ...
	 */
	public DialogoResultadosFinalesEliminacionDirecta(VentanaPrincipal principal) {
		...
		campoNombreTorneo = new JTextField("<Nombre del torneo>");
		...
		campoFechaInicio = new JTextField("31/01/2023");
		...
		campoNombreOrganizador = new JTextField("<nombre organizador>");
		...
		campoFechaFin = new JTextField("31/02/2023");
		...
		campoNombreGanador = new JTextField("nombre participantes");
		...
		etiquetaTituloTabla.setBounds(283, 145, 180, 30);
		panelAuxiliar.add(etiquetaTituloTabla);
		this.add(panelAuxiliar);
...
//		tablaListaPosiciones.setEnabled(false);
	...
	/*	if (principal.getTorneoActual().getDatosPersonalizacion().isExistenciaMarcador()) {
		...
		// modificando
				...
				etiquetaTituloTabla = new JLabel("Lugar");
				panelAuxiliar = new JPanel();
				panelAuxiliar.setPreferredSize(new Dimension(320, 20));
				panelAuxiliar.setBounds(283, 180, 140, 25);
				panelAuxiliar.add(etiquetaTituloTabla);
				panelAuxiliar.setBorder(BorderFactory.createCompoundBorder(bordeEncabezado, bordeEncabezado));
				this.add(panelAuxiliar);
				
			
				etiquetaTituloTabla = new JLabel("Núm.");
				panelAuxiliar = new JPanel();
				panelAuxiliar.setPreferredSize(new Dimension(50, 20));
				panelAuxiliar.setBounds(423, 180, 140, 25);
				panelAuxiliar.add(etiquetaTituloTabla);
				panelAuxiliar.setBorder(BorderFactory.createCompoundBorder(bordeEncabezado, bordeEncabezado));
				this.add(panelAuxiliar);
				...
				etiquetaTituloTabla = new JLabel("Nombre");
				panelAuxiliar = new JPanel();
				panelAuxiliar.setPreferredSize(new Dimension(70, 20));
				panelAuxiliar.setBounds(563, 180, 140, 25);
				panelAuxiliar.add(etiquetaTituloTabla);
				panelAuxiliar.setBorder(BorderFactory.createCompoundBorder(bordeEncabezado, bordeEncabezado));
				this.add(panelAuxiliar);
				
				etiquetaTituloTabla = new JLabel("Puntuaje");
				panelAuxiliar = new JPanel();
				panelAuxiliar.setPreferredSize(new Dimension(80, 20));
				panelAuxiliar.setBounds(703, 180, 140, 25);
				panelAuxiliar.add(etiquetaTituloTabla);
				panelAuxiliar.setBorder(BorderFactory.createCompoundBorder(bordeEncabezado, bordeEncabezado));
				this.add(panelAuxiliar);
	...
	private void encabezadoTabla() {
		tablaListaPosiciones.setEnabled(true);
...
//				.getNombreParticipante(Personalizacion.MINUSCULA_SINGULAR));
		modelo.addColumn("Nombre de participantes");
...
//		}
	...
	private void crearEncabezadoTablaEncuentros() {
		...
		etiquetasTitulosTabla = new JLabel("nombre de participante inicial");
		panelAuxiliar = new JPanel();
		...
		etiquetasTitulosTabla = new JLabel("Nombre de participante final");
		panelAuxiliar = new JPanel();
		panelAuxiliar.setPreferredSize(new Dimension(320, 30));
		panelAuxiliar.add(etiquetasTitulosTabla);
		panelAuxiliar.setBorder(BorderFactory.createCompoundBorder(bordeEncabezado, bordeEncabezado));
		...
		panelAuxiliar.setBorder(BorderFactory.createCompoundBorder(bordeEncabezado, bordeEncabezado));
		this.add(panelAuxiliar);
		//this.add(panelEncabezadoTablas);
